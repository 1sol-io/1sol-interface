...
export const POOLS_WITH_AIRDROP = [
  // FRONT
  {
    ...
    airdrops: [
      { mint: new PublicKey("SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt"), amount: 100_000 }
    ],
  },
  // SUSHI
  {
  ...
  // TOMO
  {
    ...
    airdrops: [
      { mint: new PublicKey("SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt"), amount: 100_000 },
      { mint: new PublicKey("GXMvfY2jpQctDqZ9RoU3oWPhufKiCcFEfchvYumtX7jd"), amount: 100_000 },
    ],
  },
];
